...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self._net = nn.Sequential(
            *downsample_block(channels[0], channels[1], False),
            *downsample_block(channels[1], channels[2]),
            *downsample_block(channels[2], channels[3]),
            *downsample_block(channels[3], channels[4]),
            *downsample_block(channels[4], channels[5], False, nn.Sigmoid(), 0)
        )
